...
**PLEASE NOTE: this is a fork of Taion's original package that merely swaps the react-relay imports to use `react-relay/classic` in an attempt to use this with relay 1.0**
